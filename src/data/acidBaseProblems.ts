...
export const acidBaseProblems = [
  ...
  // ============================================================
  {
    ...
    "explanation": "▼解答・解説\n（ア）水素イオン（H⁺）（またはオキソニウムイオン H₃O⁺、NH₄⁺）\n（イ）水酸化物イオン（OH⁻）\n（ウ）水素イオン H⁺（＝陽子の授受に注目した定義）\n（エ）水（水溶液・溶媒）\n（オ）酸\n（カ）塩基\n\n【問の解答】水がない気体同士の反応や、水に溶けにくい物質の酸・塩基反応も説明できる点。（39字）\n\nブレンステッド・ローリーの定義は「H⁺（陽子）の授受」に注目するため、水溶液という枠組みにとらわれず、気体同士の反応（HCl + NH₃ → NH₄Cl など）も酸・塩基反応として説明できるのが最大のメリットです。",
  ...
  },
  {
    ...
    "explanation": "▼解答・解説\n電離度 α ＝ 電離した分子の物質量 ÷ 溶かした分子の物質量 ＝ 0.0010 mol ÷ 0.10 mol ＝ 0.010\n\nよって α ＝ 0.010 です。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
  ...
  // ============================================================
  {
    ...
    "explanation": "▼解答・解説\n（１）うすめても HCl の物質量は変わらない。0.50×(10/1000)=0.0050 mol、100 mL=0.10 L なので [H⁺]=0.0050/0.10=5.0×10⁻² mol/L。\n（２）Ba(OH)₂ は2価の強塩基。[OH⁻]=2×0.10=0.20 mol/L、Kw より [H⁺]=1.0×10⁻¹⁴/0.20=5.0×10⁻¹⁴ mol/L。\n（３）弱酸なので [H⁺]=価数×濃度×電離度=1×0.40×0.010=4.0×10⁻³ mol/L。\n（４）弱塩基なので [OH⁻]=1×0.20×0.020=4.0×10⁻³ mol/L、[H⁺]=Kw/[OH⁻]=2.5×10⁻¹² mol/L。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
    ...
    "explanation": "▼解答・解説\n（１）pH=−log[H⁺]=−log(1.0×10⁻³)=3。pH<7 なので【酸性】。\n（２）[OH⁻]=1.0×10⁻³ → [H⁺]=Kw/[OH⁻]=1.0×10⁻¹⁴/1.0×10⁻³=1.0×10⁻¹¹。pH=11。pH>7 なので【塩基性】。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
    ...
    "explanation": "▼解答・解説\n（１）[H⁺] の比＝10⁻⁶/10⁻²＝10⁻⁴ ＝ 1/10000倍。\n（２）pH1（[H⁺]=10⁻¹）を1000倍希釈 → [H⁺]=10⁻⁴ → pH=4。\n（３）pH13（[OH⁻]=10⁻¹）を10000倍希釈 → [OH⁻]=10⁻⁵ → [H⁺]=10⁻⁹ → pH=9。\n（４）pH9 の塩基を薄めても酸性にはならず、水の電離の影響で pH は7に近づく（7より少し大きい値で止まる）。塩基を薄めて中性を越えて酸性になることはない点に注意。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
    ...
    "explanation": "▼解答・解説\n【答え】②\n① 誤り：塩基性でも水の自己電離により水素イオンはわずかに存在する。\n② 正しい：塩基性の水溶液では常に [H⁺]<[OH⁻]。\n③ 誤り：pH8 の [H⁺] は pH5 の [H⁺] の 10⁻³＝1/1000倍。\n④ 誤り：pH は [H⁺] の桁を表すので足して2で割る単純平均にはならない。\n⑤ 誤り：酸性（pH6）の水溶液を薄めても塩基性（pH8）にはならず、中性（pH7）に近づくだけ。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
    ...
    "explanation": "▼解答・解説\n（１）アンモニアの物質量を求めると、112 mL×(1 mol/22.4 L)＝0.0050 mol。200 mL＝0.200 L なのでモル濃度＝0.0050/0.200＝0.025 mol/L。\nアンモニアは1価、電離度α＝0.010 なので [OH⁻]＝価数×濃度×電離度＝1×0.025×0.010＝2.5×10⁻⁴ mol/L。\nKw より [H⁺]＝1.0×10⁻¹⁴/2.5×10⁻⁴＝4.0×10⁻¹¹ mol/L。\n\n（２）pH3.0 より [H⁺]＝1.0×10⁻³ mol/L。\n[H⁺]＝価数×濃度×電離度αに代入：1.0×10⁻³＝1×0.040×α。\nα＝1.0×10⁻³/0.040＝1/40＝0.025。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
    ...
    "explanation": "▼解答・解説\n【問１】pH＝2\n塩酸から生じる H⁺＝1×0.010×(100/1000)＝0.0010 mol、硫酸から生じる H⁺＝2×0.0050×(100/1000)＝0.0010 mol。合計0.0020 mol。全体積200 mL＝0.20 L なので [H⁺]＝0.0020/0.20＝1.0×10⁻² mol/L、よって pH＝2。\n\n【問２】pH＝12\n水酸化ナトリウムから生じる OH⁻＝1×0.010×(100/1000)＝0.0010 mol、水酸化バリウムから生じる OH⁻＝2×0.0050×(100/1000)＝0.0010 mol。合計0.0020 mol。[OH⁻]＝0.0020/0.20＝1.0×10⁻² mol/L。Kw より [H⁺]＝1.0×10⁻¹² mol/L、よって pH＝12。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
    ...
    "explanation": "▼解答・解説\n【問１】pH＝2\n塩酸の H⁺＝1×0.10×(60/1000)＝0.0060 mol、NaOH の OH⁻＝1×0.10×(40/1000)＝0.0040 mol。中和されて H⁺ が 0.0060−0.0040＝0.0020 mol 余る。[H⁺]＝0.0020/0.20＝1.0×10⁻² mol/L → pH＝2。\n\n【問２】pH＝12\n硫酸の H⁺＝2×0.050×(100/1000)＝0.010 mol、NaOH の OH⁻＝1×0.30×(100/1000)＝0.030 mol。中和されて OH⁻ が 0.030−0.010＝0.020 mol 余る。[OH⁻]＝0.020/0.20＝1.0×10⁻² mol/L、Kw より [H⁺]＝1.0×10⁻¹² mol/L → pH＝12。\n\n【問３】pH＝7\n硫酸の H⁺＝2×0.050×(100/1000)＝0.010 mol、NaOH の OH⁻＝1×0.10×(100/1000)＝0.010 mol。H⁺ と OH⁻ が完全に等しく「ぴったり中和」する。強酸（硫酸）と強塩基（NaOH）からできる塩（硫酸ナトリウム）の水溶液は中性なので pH＝7。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
    ...
    "explanation": "▼解答・解説\n【答え】⑤\n① 誤り：アンモニア（NH₃）のように自身に OH⁻ を持たなくても、水と反応して OH⁻ を生じ塩基性を示す物質がある。\n② 誤り：酸・塩基の「価数」が考慮されていない。2価の酸（硫酸）と1価の塩基（NaOH）を同体積・同濃度で混ぜると酸が過剰に残り酸性になる。\n③ 誤り：弱酸・弱塩基の電離度は、濃度が小さく（薄く）なるほど大きくなる。一定ではない。\n④ 誤り：pH は [H⁺] の桁を表すので足して2で割る平均にはならない。実際は約3.3。\n⑤ 正しい：酸の強さ（pHの小ささ）は価数ではなく電離度で決まる。完全電離する1価の強酸（塩酸）は、ほとんど電離しない2価の弱酸（シュウ酸）より多くの H⁺ を生じ、強い酸性を示すことがある。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
    ...
    "explanation": "▼解答・解説\n【問１】① ：水素イオン濃度は酸性が強いほど大きい。強酸（B）＞弱酸（C）＞弱塩基（A）＞強塩基（D）の順となり①。\n【問２】② ：pH の数値は塩基性が強いほど大きく（最大14）、酸性が強いほど小さい（最小0）。強塩基（D）＞弱塩基（A）＞弱酸（C）＞強酸（B）の順となり②。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  ...
  // ============================================================
  {
    ...
    "explanation": "▼解答・解説　中和反応式「H⁺ + OH⁻ → H₂O」の利用\n① 反応する物質の化学式を書く → ② H⁺ と OH⁻ がいくつあるか数える → ③ 水をつくり、残りの陽イオンと陰イオンで塩をつくる。\n（１）HCl + NaOH → NaCl + H₂O\n（２）HNO₃ + KOH → KNO₃ + H₂O\n（３）2HCl + Ca(OH)₂ → CaCl₂ + 2H₂O\n（４）H₂SO₄ + 2NaOH → Na₂SO₄ + 2H₂O",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
  ...
  },
  {
    ...
    "explanation": "▼解答・解説　塩の陽イオンに OH⁻、陰イオンに H⁺ をつければもとの塩基・酸がわかる。\n（１）酸：塩酸／塩基：水酸化ナトリウム\n（２）酸：硫酸／塩基：水酸化カリウム\n（３）酸：硝酸／塩基：水酸化カルシウム\n（４）酸：酢酸／塩基：水酸化ナトリウム\n（５）酸：硫酸／塩基：アンモニア\n（６）酸：塩酸／塩基：水酸化銅（II）\n（７）酸：炭酸／塩基：水酸化カルシウム\n（８）酸：硫化水素／塩基：水酸化鉄（II）",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
  ...
  // ============================================================
  {
    ...
    "explanation": "▼解答・解説　Point～中和が起こるとき～\n（酸の価数）×（酸の物質量）＝（塩基の価数）×（塩基の物質量）。中和の量的関係に酸・塩基の強弱や電離度は影響しない（pH を求めるときだけ電離度をかける）。\n（１）1×0.10×(20/1000)＝1×0.050×(x/1000)　→ x＝40 mL\n（２）2×0.10×(x/1000)＝1×0.20×(10/1000)　→ x＝1.0 mL\n（３）Ca(OH)₂＝0.74/74＝0.010 mol。1×0.50×(x/1000)＝2×0.010　→ x＝40 mL\n（４）NH₃＝0.56/22.4＝0.025 mol。2×0.050×(x/1000)＝1×0.025　→ x＝250 mL",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
    ...
    "explanation": "▼解答・解説\n（１）全 NH₃＝2.24/22.4＝0.10 mol。500 mL中の 20 mL分は 0.10×(20/500)＝0.0040 mol。1×0.10×(x/1000)＝1×0.0040 → x＝40 mL。\n（２）酸（H⁺）＝塩基（NH₃の物質量＋NaOHの物質量）：2×0.10×(20/1000)＝1×x＋1×0.10×(10/1000)。0.0040＝x＋0.0010 → x＝0.0030 mol＝3.0×10⁻³ mol。\n（３）HNO₃＝3.15/63＝0.050 mol。酸（HNO₃＋HCl）＝塩基（Ba(OH)₂）：1×0.050＋1×0.20×(x/1000)＝2×0.40×(200/1000)＝0.16。0.20x/1000＝0.11 → x＝550 mL＝5.5×10² mL。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
    ...
    "explanation": "▼解答・解説\n上澄み10 mLの中和に塩酸6.0 mLが必要だったので、100 mL全体なら10倍の60 mLが必要。\n酸（CO₂＋HCl）＝塩基（Ba(OH)₂）の関係を立てると：\n2×x＋1.0×10⁻²×(60/1000)＝2×4.0×10⁻³×(100/1000)\nこれを解くと x＝1.0×10⁻⁴ mol（CO₂ の物質量）。\n体積は、25℃で気体1 mol＝24.5 L なので、1.0×10⁻⁴ mol×24.5 L/mol＝2.45×10⁻³ L＝2.45 mL。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  ...
  },
  {
    ...
    "explanation": "▼解答・解説\n問１ （ア）ビュレット　（イ）ホールピペット　（ウ）コニカルビーカー　（エ）メスフラスコ　（オ）フェノールフタレイン　（カ）無色から淡い赤（ピンク）\n問２ 薄めたあとの酢酸の濃度を c とすると、1×c×(20.0/1000)＝1×5.0×10⁻²×(28.0/1000)。20.0c＝1.4 → c＝0.070 mol/L。これは10倍希釈後なので、もとの食酢は 0.070×10＝0.70 mol/L。\n問３ 1 L中の酢酸＝0.70 mol×60 g/mol＝42 g。食酢1 Lの質量＝1000 cm³×1.0 g/cm³＝1000 g。質量パーセント濃度＝42/1000×100＝4.2 %。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
    ...
    "explanation": "▼解答・解説\n問１ （ア）メスフラスコ　（イ）ホールピペット　（ウ）コニカルビーカー　（エ）ビュレット\n問２ （１）（ア）と（ウ）　（２）潮解\n問３ (COOH)₂・2H₂O の式量＝シュウ酸部分90＋水2分子36＝126。物質量＝3.15/126＝0.025 mol。500 mL＝0.500 L なので濃度＝0.025/0.500＝0.050 mol/L。\n問４ シュウ酸は2価：2×0.050×(20.0/1000)＝1×c×(25.0/1000)。2.0＝25.0c → c＝0.080 mol/L。\n問５ 薄めた酢酸 c'：1×c'×(20.0/1000)＝1×0.080×(16.0/1000)。20.0c'＝1.28 → c'＝0.064 mol/L。操作（iv）で10倍に薄めたので、元の濃度は 0.064×10＝0.64 mol/L。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
    ...
    "explanation": "▼解答・解説\n問１ （イ）。滴定されるのは弱塩基のアンモニア水なので開始pHは11前後、滴定するのは強酸の硫酸なので終点は強い酸性。中和点が酸性側に来る曲線（イ）が適切。\n問２ （１）メチルオレンジ（またはメチルレッド）。弱塩基を強酸で滴定すると中和点が酸性側に偏るため、変色域が酸性側の指示薬を用いる。（２）黄色から赤色（橙赤色）へ変化する。\n問３ 2価の硫酸と1価のアンモニアの中和：2×0.10×(10.0/1000)＝1×c×(20.0/1000)。0.0020＝0.020c → c＝0.10 mol/L。",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
  {
    ...
    "explanation": "▼解答・解説\n問１ （ア）ホールピペット　（イ）コニカルビーカー　（ウ）ビュレット　（エ）メチルオレンジ（またはメチルレッド）\n問２ 第1中和点までは、まず強塩基のNaOHが中和され、次にNa₂CO₃がNaHCO₃へ変化する。\n　NaOH＋HCl→NaCl＋H₂O\n　Na₂CO₃＋HCl→NaCl＋NaHCO₃\n問３ 第1中和点から第2中和点までは、生じたNaHCO₃が塩酸と反応してCO₂を発生する。\n　NaHCO₃＋HCl→NaCl＋H₂O＋CO₂\n問４ 第2段階（第1→第2中和点）に使った塩酸は 20.0−15.0＝5.0mL。これがNaHCO₃（＝もとのNa₂CO₃）と1:1で反応するので、Na₂CO₃の物質量 y＝0.100×(5.0/1000)＝0.00050mol。\n　第1段階（0→15.0mL）の塩酸は NaOH(x mol)＋Na₂CO₃→NaHCO₃(y mol) の両方に使われるので、x＋y＝0.100×(15.0/1000)＝0.00150mol。よって x＝0.00100mol。\n　濃度（混合水溶液20.0mL＝0.0200L）：\n　（１）NaOH＝0.00100/0.0200＝0.050 mol/L\n　（２）Na₂CO₃＝0.00050/0.0200＝0.025 mol/L",
    "surroundingKnowledge": [],
    "deepDiveTopics": []
  },
];
