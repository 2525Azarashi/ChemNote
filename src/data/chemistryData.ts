        ...
        },
        {
          ...
          "practiceProblems": [
            ...
            ),
            {
              ...
              "explanation": "▼ 解答・解説\n\n【問1】\n(1) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】組成式：CaCl₂　／　名称：塩化カルシウム</span>\n(2) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】組成式：Al₂O₃　／　名称：酸化アルミニウム</span>\n(3) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】組成式：(NH₄)₂SO₄　／　名称：硫酸アンモニウム</span>\n(4) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】組成式：Cu(NO₃)₂　／　名称：硝酸銅(II)</span>\n\n■ 思考手順（組成式のつくり方は、この3ステップで固定）\n① <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">イオンの価数を確認する</span>\n　・イオン結晶は結晶全体で電気的に中性。つまり「正電荷の総量＝負電荷の総量」になる個数比しか許されない。\n② <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">価数をたすき掛けして最も簡単な整数比を出す</span>\n　・Ca²⁺ と Cl⁻ … 2 と 1 を入れかえて Ca : Cl ＝ 1 : 2 → CaCl₂\n　・Al³⁺ と O²⁻ … 3 と 2 を入れかえて Al : O ＝ 2 : 3 → Al₂O₃\n　・NH₄⁺ と SO₄²⁻ … 1 と 2 を入れかえて 2 : 1 → (NH₄)₂SO₄\n　・Cu²⁺ と NO₃⁻ … 2 と 1 を入れかえて 1 : 2 → Cu(NO₃)₂\n③ <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">多原子イオンが2個以上なら ( ) でくくり、名称は「陰イオン → 陽イオン」の順に読む</span>\n　・(NH₄)₂SO₄ の ( ) を外して NH₄₂SO₄ と書くのは完全な誤り（原子数が変わってしまう）。\n　・銅のように複数の価数（Cu⁺, Cu²⁺）をとる金属は、名称にローマ数字を添えて 硝酸銅(II) とする。\n　・読み方は「塩化物イオン＋カルシウムイオン → 塩化カルシウム」のように、「〜物イオン」「〜イオン」を外して続けるだけ。\n\n⚠️ <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">ありがちなミス</span>：Al₂O₃ を「AlO」「Al₃O₂」としてしまう。たすき掛けは\"相手の価数を自分の右下に書く\"と覚える。\n\n【問2】\n<span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答例】（力を加えることによって）イオンの配列が一列分ずれ、同符号の電荷をもつイオンどうしが向かい合って静電気的な反発力がはたらくから。（50字程度）</span>\n\n■ 思考手順（記述はこの3段構成で書けば必ず点になる）\n① 力を加える前の状態を書く … 陽イオンと陰イオンが交互に規則正しく並び、静電気力（クーロン力）で引き合って安定している。\n② 力を加えた後の変化を書く … 層が1列分ずれると、陽イオンの隣が陽イオン、陰イオンの隣が陰イオンになる。\n③ 結果を書く … <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">引力が反発力に反転する</span>ため、その面に沿ってパリッと割れる（＝へき開／劈開）。\n\n◎対比で覚える：金属結晶は同じようにずらしても、自由電子がすべての原子を結びつけ続けるので割れずに変形する（展性・延性）。\n　「イオン結晶＝硬いがもろい／金属結晶＝変形する」はセットで暗記する。\n\n【問3】\n<span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答例】イオン結晶では多数の陽イオンと陰イオンが連続して規則正しく配列しており、「分子」という単位の粒子が存在しないから。そのためイオンの数の最も簡単な整数比（組成式）で表す。</span>\n\n◎ポイント：<span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">組成式＝粒子の数の比</span> ／ <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">分子式＝分子1個に含まれる原子の実数</span>。\n　イオン結晶・金属結晶・共有結合の結晶は組成式、分子結晶だけが分子式（ロジックツリーの STEP 1「結晶の基本と組成式・分子式」で確認）。\n<div style=\"background-color:#FFF4E5; border:2px solid #FB8C00; border-left:9px solid #FB8C00; border-radius:10px; padding:10px 12px; margin-top:12px; color:#3E2723;\">💡 【ココが狙われる！共通テスト・センター試験のリアル】\n\n■ 出典：2017年 センター試験 本試 第1問 問4a（イオン結晶でないものを選ぶ）／2025年 共通テスト（物質と化学結合の対応）／2016年 センター試験（化学結合の正誤）\n\n■ 過去問では「組成式そのもの」より、こう聞かれた！\n　・与えられた物質が イオン結晶かどうか を判定させ、そのうえで「固体は電気を通すか」「融解液は通すか」まで一気に問う複合型。\n　・「イオン結合は金属元素と非金属元素の間にできる」という原則を、例外物質で揺さぶる出題。\n\n■ このパターンのひっかけが多い！\n　⚠️ NH₄Cl や (NH₄)₂SO₄ は 非金属元素だけ からできているのに イオン結晶。「金属＋非金属＝イオン結合」だけを暗記していると必ず外す。\n　⚠️ 「イオン結晶は硬い」→ ○ だが「割れにくい」→ × （硬いが もろい ＝へき開する）。硬さと もろさ を同一視させる選択肢は定番。\n\n■ 実践アドバイス\n　組成式を書けたら終わりにせず、その物質について「固体は電気を通さない／融解液・水溶液は通す」「融点は高い」「硬いがもろい」の3点セットまで即答できる状態にしておくこと。本問の問2（へき開の記述）は、そのまま2次・私大の論述でも問われる超頻出テーマ。</div>",
              "surroundingKnowledge": [],
              "deepDiveTopics": []
            },
            {
              ...
              "explanation": "▼ 解答・解説\n\n(1) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】(b) N₂</span>　　(2) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】(c) CO₂</span>\n(3) ① <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】(c) CO₂</span>　② <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】(a) H₂ ・ (f) CH₄</span>\n(4) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】(d) H₂O ・ (e) NH₃</span>\n(5) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】(a) ア　(b) ア　(c) ア　(d) イ　(e) ウ　(f) エ</span>\n(6) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】N₂ の電子式：:N⋮⋮N:（三重結合＋両端に非共有電子対1組ずつ）／H₂O の電子式：H:O:H（O の上下に非共有電子対2組）／CO₂ の構造式：O＝C＝O／NH₃ の構造式：N から3本の単結合が出て H が3個（H－N(－H)－H）</span>\n\n■ まず「1枚の表」に落とすのが最短ルート\n分子 ｜ 共有電子対 ｜ 非共有電子対 ｜ 形 ｜ 極性\nH₂ ｜ 1 ｜ 0 ｜ 直線形 ｜ 無極性\nN₂ ｜ 3（三重結合） ｜ 2 ｜ 直線形 ｜ 無極性\nCO₂ ｜ 4（二重結合×2） ｜ 4 ｜ 直線形 ｜ 無極性\nH₂O ｜ 2 ｜ 2 ｜ 折れ線形 ｜ 極性\nNH₃ ｜ 3 ｜ 1 ｜ 三角錐形 ｜ 極性\nCH₄ ｜ 4 ｜ 0 ｜ 正四面体形 ｜ 無極性\n\n■ 思考手順（電子式 → 形 → 極性 の順にたどる）\n① <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">各原子の最外殻電子数を書き、オクテット（H は2個）になるよう電子対を組む</span>\n　・O は6個、N は5個、C は4個、H は1個。足りない分だけ共有結合の手が出る（O は2本、N は3本、C は4本、H は1本）。\n② <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">共有に使わなかった電子対＝非共有電子対を数える</span>\n　・CO₂：O 1個につき非共有電子対2組 × 2個 ＝ 4組で最多。→ (3)① の答え。\n　・H₂ と CH₄：電子はすべて共有結合に使われ、非共有電子対は0組。→ (3)② の答え。\n③ <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">中心原子まわりの「結合の数＋非共有電子対の数」から形を決める</span>\n　・CO₂：中心 C に非共有電子対なし＋結合相手2個 → 直線形。\n　・H₂O：中心 O に非共有電子対2組＋結合相手2個 → 押し下げられて 折れ線形。\n　・NH₃：中心 N に非共有電子対1組＋結合相手3個 → 三角錐形。\n　・CH₄：中心 C に非共有電子対なし＋結合相手4個 → 正四面体形。\n④ <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">「結合の極性」を矢印で書き込み、足し算して残るかどうかで分子の極性を判定する</span>\n　・CO₂ は C＝O 結合自体には極性があるが、直線形で左右対称 → ベクトルが打ち消し合って 無極性分子。\n　・CH₄ も正四面体形で対称 → 無極性分子。\n　・H₂O（折れ線）・NH₃（三角錐）は形が非対称 → 打ち消されず 極性分子。\n\n◎最重要ポイント：<span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">「結合の極性」と「分子の極性」は別もの</span>。必ず <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">分子の形（対称性）</span> まで考えてから判定すること。\n　この判定手順は、次の単元「③ 分子の相互作用と性質」の STEP 2「分子の極性」でそのまま使う土台になる。\n<div style=\"background-color:#FFF4E5; border:2px solid #FB8C00; border-left:9px solid #FB8C00; border-radius:10px; padding:10px 12px; margin-top:12px; color:#3E2723;\">💡 【ココが狙われる！共通テスト・センター試験のリアル】\n\n■ 出典：2020年 共通テスト（無極性分子を2つ選ぶ）／2021年 共通テスト 第1問 問5（極性分子と分子の形）／2024年 共通テスト 問8（CH₄・CCl₄ の立体判定）／2026年 共通テスト 問6（H₂O・CO₂・NH₃ の極性）／2017年 センター 問4b（直線形の分子）\n\n■ 過去問では、こういう要素が問われた！\n　・「分子の形」と「極性の有無」を必ずセットで問う。単独で形だけ聞く年はほとんどない。\n　・非共有電子対の数を数えさせ、そこから形（折れ線・三角錐）を導かせる、電子式と立体構造の融合問題。\n　・分子の極性を、水への溶けやすさ・沸点の高さ（水素結合）へ発展させる複合問題。\n\n■ このパターンのひっかけが多い！\n　⚠️ 最頻出は CO₂。「C＝O に極性があるから極性分子」と答えさせる誘導。正しくは 直線形で打ち消し合うので無極性。\n　⚠️ H₂O を「H－O－H だから直線形」と錯覚させる図。非共有電子対2組が結合を押し下げるので 折れ線形。\n　⚠️ NH₃ を「平面三角形」と答えさせる選択肢。非共有電子対があるので 三角錐形（平面三角形は BCl₃ など）。\n\n■ 実践アドバイス\n　演習では必ず「電子式を書く → 非共有電子対に丸をつける → 形を描く → 極性の矢印を足す」の4アクションを紙の上で実行すること。共通テストは選択肢を眺めるだけでは切れない作りになっており、この4アクションを30秒でできる生徒だけが確実に得点している。</div>",
              "surroundingKnowledge": [],
              "deepDiveTopics": []
            },
            {
              ...
              "explanation": "▼ 解答・解説\n\n(1) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】(A) ダイヤモンド　／　(B) 黒鉛（グラファイト）</span>\n(2) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】同素体：同じ元素からなる単体で、性質の異なる物質どうし。／ 例：硫黄 S ─ 斜方硫黄・単斜硫黄（ゴム状硫黄でも可）、酸素 O ─ 酸素 O₂・オゾン O₃、リン P ─ 黄リン・赤リン のいずれか</span>\n(3) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】(a) 共有結合　(b) 共有結合　(c) 分子間力（ファンデルワールス力）</span>\n(4) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】共有結合の結晶</span>\n(5) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】(A)。すべての炭素原子が4個の価電子を使い、隣り合う4個の原子と強い共有結合で正四面体状に結ばれ、立体網目構造をつくっているから。</span>\n(6) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】(B)。炭素原子の4個の価電子のうち3個だけが共有結合に使われ、残りの1個が層に沿って自由に動くことができるから。</span>\n(7) <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】層内は強い共有結合だが、層と層の間は弱い分子間力で積み重なっているだけなので、層に沿ってはがれやすいから。</span>\n\n■ 思考手順（この大問はすべて「価電子4個をどう使うか」から機械的に導ける）\n① <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">炭素の価電子は4個。それを何個ずつ結合に使っているかを図から読み取る</span>\n　・(A) は1個の C が 4個の C と結合 → 価電子4個を すべて 共有結合に使用。\n　・(B) は1個の C が 3個の C と結合 → 価電子は3個しか使わず、1個 余る。\n② <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">「使い切った → 動く電子がない」「余った → 動ける電子がある」と電気伝導性に直結させる</span>\n　・(A) 自由に動ける電子がない → 電気を通さない。\n　・(B) 余った1個の価電子が層に沿って動く → 例外的に電気を通す。→ (6) の答え。\n③ <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">結合の「強さ」と「向き」から硬さ・はがれやすさを導く</span>\n　・(A) 立体的な網目がすべて強い共有結合 → どの方向にもずれない → きわめて硬い。→ (5) の答え。\n　・(B) 層の中は強い共有結合だが、層どうしは弱い分子間力 → 層に沿ってすべる → やわらかく、はがれやすい（鉛筆の芯）。→ (7) の答え。\n\n■ 対比表（ダイヤモンドと黒鉛は「毎年どこかで出る」定番の比較）\n項目 ｜ (A) ダイヤモンド ｜ (B) 黒鉛\n結合に使う価電子 ｜ 4個すべて ｜ 3個（1個は層内を自由に動く）\n構造 ｜ 正四面体の立体網目 ｜ 正六角形の平面層＋弱い層間力\n硬さ ｜ きわめて硬い ｜ やわらかい・はがれやすい\n電気伝導性 ｜ なし ｜ あり（共有結合の結晶の例外）\n用途 ｜ 研磨剤・宝石 ｜ 鉛筆の芯・電極\n\n◎ポイント1：同素体をつくる代表元素は <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">S・C・O・P（スコップ）</span> の4つ。\n◎ポイント2：<span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">同素体</span>（構造が違う 単体 どうし）と <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">同位体</span>（中性子数が違う 原子 どうし）の混同は最頻出のミス。\n◎ポイント3：フラーレン C₆₀ やカーボンナノチューブも炭素の同素体だが、フラーレンの結晶は 分子結晶。「炭素の同素体＝すべて共有結合の結晶」ではないことに注意（ロジックツリーの STEP 3「結晶の比較・見分け方」で再確認）。\n<div style=\"background-color:#FFF4E5; border:2px solid #FB8C00; border-left:9px solid #FB8C00; border-radius:10px; padding:10px 12px; margin-top:12px; color:#3E2723;\">💡 【ココが狙われる！共通テスト・センター試験のリアル】\n\n■ 出典：2018年 センター試験 第1問 問1b（共有結合の結晶の組合せ）／2024年 共通テスト 問5（ケイ素と二酸化ケイ素の結晶構造の正誤）／黒鉛の電気伝導性は複数年で選択肢に登場\n\n■ 過去問では、こういう要素が問われた！\n　・「共有結合の結晶」に該当する物質の 組合せ を選ばせる（ダイヤモンド・黒鉛・ケイ素 Si・二酸化ケイ素 SiO₂・炭化ケイ素 SiC の5つが候補の定番）。\n　・Si や SiO₂ について「1個の Si に何個の O が結合しているか」「立体網目構造か」という 構造の細部 を正誤で問う。\n　・同素体の定義そのものを、同位体・化合物と区別させる形で問う。\n\n■ このパターンのひっかけが多い！\n　⚠️ 「共有結合の結晶は電気を通さない」と言い切る選択肢 → 黒鉛という例外があるので × になる年と、「一般に通さない」と書かれて ○ になる年の 両方 がある。言い切りの強さを必ず読むこと。\n　⚠️ ダイヤモンドと黒鉛を「同位体」と書く選択肢は毎回のように出る鉄板の誤り。\n　⚠️ ドライアイス（分子結晶）を共有結合の結晶に混ぜてくる。CO₂ は 分子の内部 が共有結合なだけで、結晶をつくっている力は分子間力。\n\n■ 実践アドバイス\n　共有結合の結晶は 「C（ダイヤモンド・黒鉛）・Si・SiO₂・SiC」の4種類だけ を丸暗記し、それ以外の非金属物質が出たら「分子結晶では？」と疑うのが最速の解法。そのうえで、黒鉛については「価電子3個使用＋1個が動く」という理由まで書けるようにしておくと、記述でも共通テストの正誤でも失点しなくなる。</div>",
              "surroundingKnowledge": [],
              "deepDiveTopics": []
            },
            {
              ...
              "explanation": "▼ 解答・解説\n\n【問1】\n① <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】(ア) H₂O ・ (オ) N₂</span>\n② <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答例】NaCl はイオン結晶、Cu は金属結晶、C（ダイヤモンド）と SiO₂ は共有結合の結晶であり、いずれも粒子が連続的に結合していて「分子」が存在しないから。（そのため構成粒子の数の比で表す）</span>\n\n■ 思考手順（化学式は「分子があるか／ないか」の一点で決まる）\n① <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">その物質に「独立した1個の分子」が存在するか？を問う</span>\n　・H₂O、N₂ は、水分子・窒素分子という 独立した粒子 が実在する → 分子式。\n② <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">存在しないなら、粒子が無限につながった巨大な集合体だと考える</span>\n　・NaCl … Na⁺ と Cl⁻ が交互に無限に並ぶ（イオン結晶）。\n　・Cu … 金属原子と自由電子が無限に並ぶ（金属結晶）。\n　・C（ダイヤモンド）、SiO₂ … 原子が共有結合で無限につながる（共有結合の結晶）。\n③ <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">分子がないので「数の最も簡単な整数比」＝組成式で表す</span>\n　・SiO₂ は「Si 1個と O 2個の分子」ではなく、Si : O ＝ 1 : 2 という 比 を示しているだけ。\n\n◎覚え方：<span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">分子結晶だけが分子式、残りの3結晶（イオン・共有結合・金属）はすべて組成式</span>（ロジックツリー STEP 1 の内容と完全に一致）。\n\n【問2】\n物質 ｜ 結晶中の化学結合\n(a) ドライアイス CO₂ ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】共有結合</span>\n(b) 鉄 Fe ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】金属結合</span>\n(c) 塩化アンモニウム NH₄Cl ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】イオン結合・共有結合・配位結合</span>\n(d) 二酸化ケイ素 SiO₂ ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】共有結合</span>\n\n■ 解説（差がつくのは (a) と (c)）\n・(a) CO₂：分子の中の C と O は共有結合。分子どうしを結びつけている <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">分子間力は「化学結合」には数えない</span> のがルール。ここを「分子間力も答えに入れる」としてしまう答案が非常に多い。\n・(c) NH₄Cl が本問の核心。NH₄⁺ の中の N－H 結合は、3本が通常の共有結合、残る1本は N の非共有電子対を H⁺ に提供してできた <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">配位結合</span>。さらに NH₄⁺ と Cl⁻ の間は <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">イオン結合</span>。つまり1つの結晶に3種類の結合が共存する。\n　なお配位結合は、いったんできてしまえば他の3本の共有結合と まったく区別できない（結合の長さも強さも同じ）。\n・(d) SiO₂：Si と O が交互に共有結合した立体網目構造（水晶・石英）。金属元素を含まないのでイオン結合ではない。\n\n◎ポイント：<span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">配位結合＝共有電子対を一方の原子だけが提供する共有結合</span>。2大例は <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">NH₄⁺（アンモニウムイオン）</span> と <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">H₃O⁺（オキソニウムイオン）</span>。\n<div style=\"background-color:#FFF4E5; border:2px solid #FB8C00; border-left:9px solid #FB8C00; border-radius:10px; padding:10px 12px; margin-top:12px; color:#3E2723;\">💡 【ココが狙われる！共通テスト・センター試験のリアル】\n\n■ 出典：2022年 共通テスト 第1問 問1（H₃O⁺ における共有結合と配位結合）／2025年 共通テスト 問4（物質と化学結合の対応）／2016年 センター試験 問4（化学結合の正誤）／2017年 センター試験 問3（単結合のみからなる分子）\n\n■ 過去問では、こういう要素が問われた！\n　・物質名と「その結晶を成り立たせている結合」を1対1で対応させる、まさに本問と同型の出題。\n　・H₃O⁺ や NH₄⁺ を題材に「この中に配位結合は何本あるか」「配位結合と共有結合は区別できるか」を問う。\n　・化学式が組成式か分子式かを、結晶の種類とセットで判断させる。\n\n■ このパターンのひっかけが多い！\n　⚠️ 「NH₄⁺ の4本の N－H のうち、配位結合の1本だけ結合の長さが違う」→ ×。できたあとは 完全に等価 で区別できない。ほぼ毎回このニュアンスで狙われる。\n　⚠️ ドライアイスの結晶に「イオン結合がある」「共有結合はない」とする選択肢。分子の 内部 は共有結合、分子 どうし は分子間力、と2段階で答える癖をつける。\n　⚠️ 「氷は水素結合でできているから化学結合は水素結合だけ」→ ×。H₂O 分子内の O－H は共有結合。\n\n■ 実践アドバイス\n　選択肢の物質を見たら、必ず 「主たる結合＋粒子間の力」の2段で書き出す こと（例：CO₂ ＝ C＝O 共有結合 ＋ 分子間力／NH₄Cl ＝ 共有結合＋配位結合 ＋ イオン結合）。この2段書きができていれば、化学結合の正誤問題（出題確率70%）はほぼ落とさない。</div>",
              "surroundingKnowledge": [],
              "deepDiveTopics": []
            },
            {
            ...
            },
            {
              ...
              "explanation": "▼ 解答・解説\n\n結晶 ｜ でき方［A群］ ｜ 性質［B群］ ｜ 例［C群］\n(1) 金属結晶 ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">エ</span> ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">キ</span> ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">サ（アルミニウム）</span>\n(2) 共有結合の結晶 ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">イ</span> ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">オ</span> ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">ケ（ケイ素）</span>\n(3) 分子結晶 ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">ウ</span> ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">ク</span> ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">コ（ナフタレン）</span>\n(4) イオン結晶 ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">ア</span> ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">カ</span> ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">シ（塩化カリウム）</span>\n\n■ 思考手順（3つの群は「構成粒子」を軸にすれば一気につながる）\n① <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">まず A群で「何が集まっているか（構成粒子）」を確定する</span>\n　・(ア) 陽イオン＋陰イオン → イオン結晶　／　(イ) 原子＋価電子の共有 → 共有結合の結晶\n　・(ウ) 分子＋弱い分子間力 → 分子結晶　／　(エ) 原子＋自由電子 → 金属結晶\n② <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">B群は「電気を通すか」だけで4つに割り切れる</span>\n　・固体も液体も通す＋展性延性 → (キ) 金属結晶（自由電子が動くから）\n　・固体は通さないが融解液・水溶液は通す → (カ) イオン結晶（イオンが動けるようになるから）\n　・通さない＋きわめて硬い＋超高融点 → (オ) 共有結合の結晶\n　・通さない＋やわらかい＋低融点＋昇華 → (ク) 分子結晶\n③ <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">C群は元素の組合せで機械的に判定する</span>\n　・(サ) アルミニウム … 金属元素のみ → 金属結晶\n　・(ケ) ケイ素 … 非金属で巨大に共有結合 → 共有結合の結晶（ダイヤモンドと同じ構造）\n　・(コ) ナフタレン … 分子（C₁₀H₈、防虫剤）で昇華する → 分子結晶\n　・(シ) 塩化カリウム … 金属＋非金属（K⁺ と Cl⁻） → イオン結晶\n\n■ この表は暗記の最終形（ロジックツリー STEP 3「結晶の比較・見分け方」と同じ内容）\n結晶 ｜ 構成粒子 ｜ 粒子をつなぐ力 ｜ 融点 ｜ 電気伝導性 ｜ 代表例\n金属結晶 ｜ 金属原子（陽イオン） ｜ 金属結合（自由電子） ｜ さまざま ｜ 固体○ 液体○ ｜ Al, Fe, Cu\n共有結合の結晶 ｜ 原子 ｜ 共有結合 ｜ 非常に高い ｜ ×（黒鉛は例外で○） ｜ C, Si, SiO₂, SiC\n分子結晶 ｜ 分子 ｜ 分子間力（弱い） ｜ 低い ｜ × ｜ CO₂, I₂, ナフタレン, 氷\nイオン結晶 ｜ 陽イオン・陰イオン ｜ イオン結合（静電気力） ｜ 高い ｜ 固体× 融解液・水溶液○ ｜ NaCl, KCl\n\n◎ポイント：昇華する物質（<span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">ドライアイス・ヨウ素・ナフタレン</span>）はすべて 分子結晶。共有結合の結晶は <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">C・Si・SiO₂・SiC の4つだけ</span> と割り切ってよい。\n<div style=\"background-color:#FFF4E5; border:2px solid #FB8C00; border-left:9px solid #FB8C00; border-radius:10px; padding:10px 12px; margin-top:12px; color:#3E2723;\">💡 【ココが狙われる！共通テスト・センター試験のリアル】\n\n■ 出典：2017年 センター試験 問4a（イオン結晶でないものを選ぶ）／2018年 センター試験 問1b（共有結合の結晶）／2021年 共通テスト 問7（単位格子モデル）／2024年 共通テスト 問5（ケイ素と SiO₂ の結晶構造）\n\n■ 過去問では、こういう要素が問われた！\n　・まさに本問と同じ「結晶の種類 × 性質 × 代表物質」の3点対応。共通テストでは表や実験結果の形に化けて出る。\n　・「電気伝導性」を軸に、固体のとき／融解したとき／水に溶かしたとき の3条件を区別させる。\n　・単位格子の図を見せ、含まれる粒子の数や結晶の種類を判断させる図示型（2021年）。\n\n■ このパターンのひっかけが多い！\n　⚠️ 「イオン結晶は電気を通す」だけの記述 → 条件（融解液・水溶液）が抜けていれば ×。逆に「固体でも通す」は明確な誤り。\n　⚠️ 黒鉛を「電気を通すから金属結晶」とする選択肢。黒鉛はあくまで 共有結合の結晶（例外的に電気を通すだけ）。\n　⚠️ 「分子結晶は分子間力が弱いから、分子内の結合も弱い」→ ×。分子 内部 の共有結合は強い。壊れやすいのは分子 どうし の結びつき。\n　⚠️ ヨウ素 I₂ を「共有結合の結晶」と分類させる誘導。I₂ は分子なので 分子結晶。\n\n■ 実践アドバイス\n　この4×5の比較表は、テスト直前に 白紙から書き出せる ようにしておくのが最強の対策。「結晶名 → 4つの性質」「性質 → 結晶名」の 双方向 で言えるかを必ずチェックすること。共通テストは後者（性質から逆算）で出題されることが多い。</div>",
              "surroundingKnowledge": [],
              "deepDiveTopics": []
            },
            {
            ...
            },
            {
              ...
              "explanation": "▼ 解答・解説\n\n【問1・問2】\n ｜ 結晶の種類 ｜ 物質 ｜ 判断の決め手\nA ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">イオン結晶</span> ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">塩化マグネシウム</span> ｜ 固体× ／ 融解液・水溶液○ の電気伝導性\nB ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">共有結合の結晶</span> ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">二酸化ケイ素</span> ｜ きわめて硬い・融点が非常に高い・水晶（石英）\nC ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">分子結晶</span> ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">ドライアイス</span> ｜ 昇華性＋無色＋直線形の無極性分子（CO₂）\nD ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">金属結晶</span> ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">銅</span> ｜ 赤みを帯びた光沢・展性延性・電線\nE ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">共有結合の結晶</span> ｜ <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">黒鉛</span> ｜ 非金属なのに電気を通す・薄くはがれる\n\n■ 思考手順（未知物質の同定は「電気伝導性 → 硬さ・融点 → 色や用途」の順で絞る）\n① <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">まず電気を通すかどうかで大きく2つに割る</span>\n　・固体で通す … D（金属光沢あり→金属結晶）と E（金属ではない→黒鉛の例外パターン）。\n　・固体で通さない … A・B・C。\n② <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">通さない組は「融解・水溶液で通るか」で決着する</span>\n　・融解液・水溶液で通る → イオンが動ける＝A は イオン結晶。\n　・液体でも通らない → B・C。ここは 融点と硬さ で分ける（超高融点・きわめて硬い → 共有結合の結晶 B ／ 昇華する → 分子結晶 C）。\n③ <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">語群から色・状態・用途のキーワードで1つに確定する</span>\n　・A：Mg²⁺ と Cl⁻ とあるので 塩化マグネシウム。\n　・B：「水晶（石英）」の一語で 二酸化ケイ素 に確定。\n　・C：昇華する分子結晶はヨウ素とドライアイスの2択だが、「無色」「直線形の無極性分子」から CO₂＝ドライアイス（ヨウ素 I₂ は 黒紫色 で誤り）。\n　・D：「赤みを帯びた」金属は 銅（アルミニウムは 銀白色 なので誤り）。\n　・E：非金属なのに電気を通す・鉛筆の芯 → 黒鉛。共有結合の結晶の 例外 として必ず押さえる。\n\n【問3】\n① <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】MgCl₂</span>\n② <span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答例】固体では陽イオンと陰イオンが決まった位置に固定されて動けないが、融解するとイオンが自由に動けるようになり、電気を運ぶことができるから。</span>\n　・Mg²⁺（2＋）と Cl⁻（1−）を電気的に中性になるよう 1 : 2 で組み合わせる（発展1と同じたすき掛け）。\n　・<span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">電気伝導には「電荷を運ぶ粒子（イオン・自由電子）が動けること」が必要</span>。イオン結晶は「固体＝動けない／液体・水溶液＝動ける」の対比で書く。\n\n【問4】\n<span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答例】CO₂ 分子は直線形で、2つの C＝O 結合の極性が互いに反対向きで打ち消し合うから。</span>\n　・発展2で確認した「結合の極性 ≠ 分子の極性」がそのまま問われている。必ず 分子の形（直線形） に言及すること。\n\n【問5】\n<span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】薄く広がる性質…展性　／　細く延びる性質…延性</span>\n<span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答例】理由：金属中を自由電子が移動できるため電気をよく導き、また原子の配列がずれても自由電子がすべての原子を結びつけ続けるため、割れずに変形できるから。</span>\n　・◎対比：イオン結晶は「ずれると同符号イオンが反発して割れる」（発展1問2）、金属は「ずれても自由電子が結合を保つので変形できる」。<span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">この2つは必ずセットで記述できるようにする</span>。\n\n【問6】\n<span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答例】分子どうしを結びつけている分子間力が非常に弱いため、分子が結晶から離れやすいから。</span>\n　・「分子 内部 の共有結合が弱いから」と書くと ×。弱いのは あくまで分子 どうし をつなぐ力。\n\n【問7】\n<span style=\"background-color:#ffc0cb; color:#1a1a1a; font-weight:bold; padding:1px 6px; border-radius:5px;\">【解答】(イ) ・ (オ)</span>\n・(ア) 誤り … NaCl はイオン結晶で 分子は存在しない。NaCl は組成式（イオンの数の比）。\n・(イ) 正しい … 配位結合は電子対の出どころが違うだけで、できてしまえば通常の共有結合とまったく同等（発展4 の NH₄Cl と同じ論点）。\n・(ウ) 誤り … ダイヤモンドと黒鉛は 同素体。同位体は中性子の数が異なる 原子 どうし。\n・(エ) 誤り … 水分子は 折れ線形 なので極性が打ち消されず 極性分子。\n・(オ) 正しい … 氷は分子結晶であり、分子結晶の融点は一般に低い。\n\n◎総まとめ：この1題で「イオン結晶と組成式（発展1）」「分子の形と極性（発展2）」「同素体と黒鉛（発展3）」「配位結合と分子の有無（発展4）」「4分類とその性質（発展5）」がすべて確認できる。テスト直前は <span style=\"background-color:#ffd8a8; color:#1a1a1a; font-weight:bold; padding:1px 4px; border-radius:4px;\">この総合演習だけでも解き直す</span> と、単元全体の穴が一気に洗い出せる。\n<div style=\"background-color:#FFF4E5; border:2px solid #FB8C00; border-left:9px solid #FB8C00; border-radius:10px; padding:10px 12px; margin-top:12px; color:#3E2723;\">💡 【ココが狙われる！共通テスト・センター試験のリアル】\n\n■ 出典：2017年 センター試験 問4a（イオン結晶でないもの）／2018年 センター試験 問1b（共有結合の結晶）／2021年 共通テスト 問5・問7（極性と分子の形／単位格子）／2024年 共通テスト 問5（Si・SiO₂ の結晶構造）／2025年 共通テスト 問4（物質と化学結合）／2026年 共通テスト 問6（H₂O・CO₂・NH₃ の極性）\n\n■ 過去問では、こういう要素が問われた！\n　・本問と同じ「実験結果から未知の固体を同定する」形式が、共通テストの思考力型問題として定着している。判断材料は ほぼ必ず電気伝導性・融点・硬さ・昇華性 の4つ。\n　・複数分野（結合の種類＋結晶の性質＋分子の極性）を1問に束ねた 総合正誤問題。まさに問7の形。\n　・「金属の展性・延性を自由電子で説明する」記述の内容が、正誤選択肢の形に変換されて出題される。\n\n■ このパターンのひっかけが多い！\n　⚠️ 「昇華する ＝ 分子結晶」は正しいが、逆に 「分子結晶はすべて昇華する」は誤り（氷や砂糖は昇華しない）。この逆命題のすり替えは頻出。\n　⚠️ 黒鉛を「電気を通すから金属結晶」とする定番の誤答誘導。E のような問題文で必ず仕掛けられている。\n　⚠️ 色の情報でふるいにかける出題（無色＝CO₂／黒紫色＝I₂、銀白色＝Al／赤色＝Cu）。物質の 見た目 を軽視していると、結晶の分類が合っていても物質名で失点する。\n　⚠️ 2027年に向けては、trend データの予測どおり 共有結合の結晶（ダイヤモンド・Si・SiO₂）の性質正誤 と 分子の極性 が最有力テーマ。本問の B・C はまさにその2大テーマの融合。\n\n■ 実践アドバイス\n　総合問題は「読んだ順に答える」のではなく、まず A〜E すべてに 電気伝導性の○×を書き込む ところから始めること。そのうえで4分類の比較表（発展5）を思い出せば、物質名は最後に自動的に決まる。共通テスト本番でも、この「表を先に埋める」手順が最も速く、最も事故が少ない。</div>",
              "surroundingKnowledge": [],
              "deepDiveTopics": []
            },
            // ── 教科書順⑥：章末の総合演習 ──
