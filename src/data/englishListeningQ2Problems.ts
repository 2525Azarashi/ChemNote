...
const EL2_SET6_TRACKS: ListeningAudioTrack[] = [
  ...
  },
  {
    ...
    script: 'M: Where should I hang this banner?\nW: On the wall above the sofa.\nM: And these balloons?\nW: Tie them to the corners of the dining table, please.',
    turns: [
      { who: 'M', text: 'Where should I hang this banner?' },
      { who: 'W', text: 'On the wall above the sofa.' },
      { who: 'M', text: 'And these balloons?' },
      { who: 'W', text: 'Tie them to the corners of the dining table, please.' },
    ],
    translation: '',
    keyPhrases: [],
  },
...
Question: Which arrangement matches their plan?
イラスト①〜④から、対話と設問の内容に合うものを選びなさい。（1枚の図の中に①〜④）`,
  subQuestions: [
    {
      id: 'q_el2_set6_1',
    ...
    {
      id: 'q_el2_set6_3',
      label: '問3 Which arrangement matches their plan?',
      type: 'multiple_choice',
      options: MARK_OPTIONS,
      correctAnswer: '①',
      correctAnswerRate: 62,
      ...
      imageCaption: '問3 の図（①〜④の位置）',
      detailedExplanation: {
        theme: '旗（above the sofa）と風船（corners of the dining table）の2つの場所の対応',
        type: 'イラスト選択型（短い対話）',
        difficulty: 3,
        steps: [
          '① 音声の前に「場面（日本語）」を読み、4枚の絵の違いを1語で言語化する（色・数・位置・有無）',
...
スクリプト：M: Where should I hang this banner?
W: On the wall above the sofa.
M: And these balloons?
W: Tie them to the corners of the dining table, please.
Question: Which arrangement matches their plan?
選択肢のイラスト：
① ソファ上に旗、ダイニングテーブルの角に風船
② ドア上に旗、ソファの角に風船
③ ソファ上に旗、ソファの角に風船
④ ダイニングテーブル上に旗、ソファの角に風船
正解の選択肢：① ソファ上に旗、ダイニングテーブルの角に風船
旗（above the sofa）と風船（corners of the dining table）の2つの場所の対応。2022年問8型（位置指定）。`,
  surroundingKnowledge: [
    '第2問は2回読み。1回目で候補を2つに絞り、2回目で決め手を確認する二段構えが基本。',
    '「訂正の型」が最頻出。No, actually … / the other one / not A but B の後ろが答えになる。',
    '属性の絞り込み（色・形・サイズ・柄・数）は3条件以上重なる。1条件だけ合う絵はダミー。',
...
const EL2_SET7_TRACKS: ListeningAudioTrack[] = [
  ...
  },
  {
    subId: 'q_el2_set7_3',
    label: '問3',
    hint: '男女が飛行機の座席を選んでいる。（話者：男性 / 女性）',
    script: 'M: There are window seats and aisle seats left.\nW: I want to look outside, but I also don\'t want to disturb others when I stand up.\nM: So which one?\nW: Window, please. I\'ll try not to stand up much.',
    turns: [
      { who: 'M', text: 'There are window seats and aisle seats left.' },
      { who: 'W', text: 'I want to look outside, but I also don\'t want to disturb others when I stand up.' },
      { who: 'M', text: 'So which one?' },
      { who: 'W', text: 'Window, please. I\'ll try not to stand up much.' },
    ],
    translation: '',
    keyPhrases: [],
  },
...
イラスト①〜④から、対話と設問の内容に合うものを選びなさい。（2×2の4枚から選択）`,
  subQuestions: [
    ...
    },
    {
      ...
      imageCaption: '問3 の選択肢イラスト（①〜④の4枚）',
      detailedExplanation: {
        theme: '迷いながらも Window, please. で最終確定',
        type: 'イラスト選択型（短い対話）',
        difficulty: 4,
        steps: [
          '① 音声の前に「場面（日本語）」を読み、4枚の絵の違いを1語で言語化する（色・数・位置・有無）',
...
問3　正解は ①
場面：男女が飛行機の座席を選んでいる。（話者：男性 / 女性）
スクリプト：M: There are window seats and aisle seats left.
W: I want to look outside, but I also don't want to disturb others when I stand up.
M: So which one?
W: Window, please. I'll try not to stand up much.
Question: Which seat will the woman choose?
...
④ 非常口横の席
正解の選択肢：① 窓側の席
迷いながらも Window, please. で最終確定。前半の逡巡で誤答を誘う。`,
  surroundingKnowledge: [
    '第2問は2回読み。1回目で候補を2つに絞り、2回目で決め手を確認する二段構えが基本。',
    '「訂正の型」が最頻出。No, actually … / the other one / not A but B の後ろが答えになる。',
    '属性の絞り込み（色・形・サイズ・柄・数）は3条件以上重なる。1条件だけ合う絵はダミー。',
...
const EL2_SET8_TRACKS: ListeningAudioTrack[] = [
  ...
  },
  {
    subId: 'q_el2_set8_3',
    label: '問3',
    hint: '男女が引越しの荷物の整理をしている。（話者：男性 / 女性）',
    script: 'M: This box is books, and this is clothes. Where should they go?\nW: Books in the bedroom, clothes in the closet.\nM: And the kitchen items?\nW: Leave those in the kitchen, please.',
    turns: [
      { who: 'M', text: 'This box is books, and this is clothes. Where should they go?' },
      { who: 'W', text: 'Books in the bedroom, clothes in the closet.' },
      { who: 'M', text: 'And the kitchen items?' },
      { who: 'W', text: 'Leave those in the kitchen, please.' },
    ],
    translation: '',
    keyPhrases: [],
  },
...
イラスト①〜④から、対話と設問の内容に合うものを選びなさい。（2×2の4枚から選択）`,
  subQuestions: [
    ...
    {
      id: 'q_el2_set8_3',
      label: '問3 Which arrangement is correct?',
      type: 'multiple_choice',
      options: MARK_OPTIONS,
      correctAnswer: '①',
      correctAnswerRate: 62,
...
問3　正解は ①
場面：男女が引越しの荷物の整理をしている。（話者：男性 / 女性）
スクリプト：M: This box is books, and this is clothes. Where should they go?
W: Books in the bedroom, clothes in the closet.
M: And the kitchen items?
W: Leave those in the kitchen, please.
Question: Which arrangement is correct?
選択肢のイラスト：
① 本→寝室、服→クローゼット、台所用品→台所
② 本→クローゼット、服→寝室、台所用品→台所
③ 本→台所、服→クローゼット、台所用品→寝室
④ 本→寝室、服→台所、台所用品→クローゼット
正解の選択肢：① 本→寝室、服→クローゼット、台所用品→台所
3対応（本／服／台所用品）を正確に。1つでも入れ替えると不正解になる典型型。`,
  surroundingKnowledge: [
    '第2問は2回読み。1回目で候補を2つに絞り、2回目で決め手を確認する二段構えが基本。',
    '「訂正の型」が最頻出。No, actually … / the other one / not A but B の後ろが答えになる。',
    '属性の絞り込み（色・形・サイズ・柄・数）は3条件以上重なる。1条件だけ合う絵はダミー。',
...
const EL2_SET11_TRACKS: ListeningAudioTrack[] = [
  {
    subId: 'q_el2_set11_1',
    label: '問1',
    hint: '男女がホームパーティーの飲み物を用意している。（話者：女性 / 男性）',
    script: 'W: How many bottles of juice should I get?\nM: Ten guests, so let\'s say six bottles.\nW: And water?\nM: Same number as juice.',
    turns: [
      { who: 'W', text: 'How many bottles of juice should I get?' },
      { who: 'M', text: 'Ten guests, so let\'s say six bottles.' },
      { who: 'W', text: 'And water?' },
      { who: 'M', text: 'Same number as juice.' },
    ],
    translation: '',
    keyPhrases: [],
  },
...
────────────────────
問1（話者：女性 / 男性）
場面：男女がホームパーティーの飲み物を用意している。
Question: How many bottles in total?
イラスト①〜④から、対話と設問の内容に合うものを選びなさい。（2×2の4枚から選択）
...
イラスト①〜④から、対話と設問の内容に合うものを選びなさい。（2×2の4枚から選択）`,
  subQuestions: [
    {
      id: 'q_el2_set11_1',
      label: '問1 How many bottles in total?',
      type: 'multiple_choice',
      options: MARK_OPTIONS,
      correctAnswer: '②',
      correctAnswerRate: 68,
      ...
      imageCaption: '問1 の選択肢イラスト（①〜④の4枚）',
      detailedExplanation: {
        theme: 'Same number as juice の代名詞的な数量表現',
        type: 'イラスト選択型（短い対話）',
        difficulty: 3,
        steps: [
          '① 音声の前に「場面（日本語）」を読み、4枚の絵の違いを1語で言語化する（色・数・位置・有無）',
...
問1　正解は ②
場面：男女がホームパーティーの飲み物を用意している。（話者：女性 / 男性）
スクリプト：W: How many bottles of juice should I get?
M: Ten guests, so let's say six bottles.
W: And water?
M: Same number as juice.
Question: How many bottles in total?
...
③ ジュース10本＋水10本＝20本
④ 水6本のみ
正解の選択肢：② ジュース6本＋水6本＝12本
Same number as juice の代名詞的な数量表現。合計を求める計算型。ゲスト数10はダミー。
...
const EL2_SET13_TRACKS: ListeningAudioTrack[] = [
  {
    subId: 'q_el2_set13_1',
    label: '問1',
    hint: '男女が地図を見ながらキャンプ場までの道を確認している。（話者：男性 / 女性）',
    script: 'M: At the first crossroads, turn left.\nW: Then straight until the bridge?\nM: No, turn right before the bridge and go past the lake.\nW: Got it. The campsite is after the lake, right?',
    turns: [
      { who: 'M', text: 'At the first crossroads, turn left.' },
      { who: 'W', text: 'Then straight until the bridge?' },
      { who: 'M', text: 'No, turn right before the bridge and go past the lake.' },
      { who: 'W', text: 'Got it. The campsite is after the lake, right?' },
    ],
    translation: '',
    keyPhrases: [],
  },
...
────────────────────
問1（話者：男性 / 女性）
場面：男女が地図を見ながらキャンプ場までの道を確認している。
Question: Which route matches?
イラスト①〜④から、対話と設問の内容に合うものを選びなさい。（1枚の図の中に①〜④）
  ...
  subQuestions: [
    {
      ...
      imageCaption: '問1 の図（①〜④の位置）',
      detailedExplanation: {
        theme: '複数の分岐（left→before the bridge→right→past the lake）を順番通りに追う道順型',
        type: 'イラスト選択型（短い対話）',
        difficulty: 4,
        steps: [
          '① 音声の前に「場面（日本語）」を読み、4枚の絵の違いを1語で言語化する（色・数・位置・有無）',
...
問1　正解は ②
場面：男女が地図を見ながらキャンプ場までの道を確認している。（話者：男性 / 女性）
スクリプト：M: At the first crossroads, turn left.
W: Then straight until the bridge?
M: No, turn right before the bridge and go past the lake.
W: Got it. The campsite is after the lake, right?
Question: Which route matches?
選択肢のイラスト：
① 最初の交差点で左折→橋を渡って直進→キャンプ場
② 最初の交差点で左折→橋の手前で右折→湖を通過→キャンプ場
③ 最初の交差点で右折→湖を通過→橋を渡る→キャンプ場
④ 最初の交差点で左折→湖を通過→橋を渡る→キャンプ場
正解の選択肢：② 最初の交差点で左折→橋の手前で右折→湖を通過→キャンプ場
複数の分岐（left→before the bridge→right→past the lake）を順番通りに追う道順型。2025年問11のルート型。
...
const EL2_SET16_TRACKS: ListeningAudioTrack[] = [
  ...
  },
  {
    ...
    script: 'M: My shoe locker is B-15.\nW: So it\'s in row B, right? Second from the top?\nM: No, third from the top. And on the right side.\nW: OK, I\'ll bring your gym bag there.',
    turns: [
      { who: 'M', text: 'My shoe locker is B-15.' },
      { who: 'W', text: 'So it\'s in row B, right? Second from the top?' },
      { who: 'M', text: 'No, third from the top. And on the right side.' },
      { who: 'W', text: 'OK, I\'ll bring your gym bag there.' },
    ],
    translation: '',
    keyPhrases: [],
  },
...
イラスト①〜④から、対話と設問の内容に合うものを選びなさい。（2×2の4枚から選択）`,
  subQuestions: [
    ...
    },
    {
      ...
      imageCaption: '問2 の選択肢イラスト（①〜④の4枚）',
      detailedExplanation: {
        theme: '列（B）＋段（third from top）＋左右（right side）の3座標',
        type: 'イラスト選択型（短い対話）',
        difficulty: 3,
        steps: [
          '① 音声の前に「場面（日本語）」を読み、4枚の絵の違いを1語で言語化する（色・数・位置・有無）',
...
スクリプト：M: My shoe locker is B-15.
W: So it's in row B, right? Second from the top?
M: No, third from the top. And on the right side.
W: OK, I'll bring your gym bag there.
Question: Which locker is the man's?
...
④ B列 上から2番目 左側
正解の選択肢：③ B列 上から3番目 右側
列（B）＋段（third from top）＋左右（right side）の3座標。訂正あり（2番目→3番目）。
