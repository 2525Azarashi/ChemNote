...
import { ArrowLeft, CalendarCheck, Clock, Coins, Gift, PartyPopper, Sparkles } from 'lucide-react';
import { allMissionsClaimed, chestOpenedToday, completeChestFor, currentCompleteStreak, localDateKey, missionsForDate, msUntilNextDay, rolloverDaily, type CompleteChest, type GrowthProgress } from '../core/growth';
  ...
  return (
    ...
    >
      ...
      <p className="mt-4 flex items-start gap-1.5 text-[10px] font-bold leading-relaxed" style={{ color: INK_SUB }}>
        ...
        復習リストの「できた」で進みます。同じ問題は1日1回までです。3つ全部うけとると宝箱が開き、7日連続で大当たりです。
      </p>
    </BattleShell>
  );
}
